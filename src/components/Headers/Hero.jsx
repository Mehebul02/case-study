...
import video from "../../assets/images/solo-vibe-background.webm";
const Hero = () => {
  return (
    <section className=" ">
      <div className=" flex flex-col  p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between ">
        <div className="flex flex-col justify-center p-6 text-center rounded-sm   lg:text-left">
          <div className="flex items-center gap-2">
            <div className="w-4 h-4  f rounded-full  bg-green-600"></div>
            <h1 className="text-sm font-poppins font-medium">122 Online Now</h1>
          </div>
          <h1 className=" text-2xl lg:text-5xl font-poppins font-semibold leading-none sm:text-5xl p-2">
            Working towards your <br />
            dreams is hard. Not <br />
            reaching them is harder
          </h1>
          <p className="mt-6 mb-8 text-lg sm:mb-12 flex items-center gap-2">
            Get work done with other from
            <br className="hidden md:inline lg:hidden" /> around the{" "}
            <BiWorld></BiWorld>
          </p>
